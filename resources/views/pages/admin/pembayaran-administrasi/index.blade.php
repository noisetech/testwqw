...
@section('title', 'Pembayaran Administasi')
@section('content')
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="font-weight-bold text-primary mt-2">
                    <p>Pembayaran Administrasi</p>
                </div>

                <a href="{{ route('pembayaran_administrasi.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                               <div class="d-flex justify-content-center align-items-center">
                                <a href="{{ route('pembayaran_administrasi.edit', $item->id) }}" class="btn btn-sm btn-warning mr-2">
                                    <i class="fas fa-sm fa-edit"></i>
                                </a>

                                <form action="{{ route('pembayaran_administrasi.destroy', $item->id) }}" method="POST">
                                    @csrf
