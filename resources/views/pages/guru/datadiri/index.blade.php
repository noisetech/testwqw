...
@section('title', 'halaman data diri guru')
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-center m-0">
                            <a href="{{ route('cetak.data.diri.guru') }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6  mb-3">
                        <div class="d-flex justify-content-center mt-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img src="{{ Storage::url($datadiri->gambar) }}" alt="" width="250px" height="250px" class="img-thumbnail rounded">
                                </div>
                            </div>
                        </div>
                    </div>
